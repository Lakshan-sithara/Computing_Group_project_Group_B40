...
namespace Schoolmanagementsystem
{
    public partial class Addstudentdetails : Form
    {
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                string insertQuery = "INSERT INTO student (Name, Admission_number, DOB, Religion, Address, Father_name, Mother_name, gender,Grade,Class) " +
                                     "VALUES ('" + nameTB.Text + "', '" + AdmiNuTB.Text + "', '" + DOBDTP.Value.ToString("yyyy-MM-dd") + "', '" + religionTB.Text + "', " +
                                     "'" + addressTB.Text + "', '" + fatherTB.Text + "', '" + motherTB.Text + "', '" + Gender + "','" + grade + "','" + Class + ")";
